...
def compute_ngal(logM,mass_function,probC,probS):
...
def compute_fsat(logM,mass_function,probC,probS):
    ngal = compute_ngal(logM,mass_function,probC,probS)
...
class Occupation:
    ...
    def set_params(self, dict_params):
        try:
            [dict_params[key] for key in self.params]
